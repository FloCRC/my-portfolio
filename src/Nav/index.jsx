...
export default function Nav() {
    ...
    return (
        <section className="flex flex-col justify-between w-[10rem] h-screen border-e border-gray-600">
            ...
            <nav className="flex flex-col items-center py-1 border-t border-gray-600 w-[10rem]">
                <a href="#contact" className="pb-1 text-gray-600 font-['Playwrite_DE_Grund'] hover:opacity-40">Contact</a>
                <div className="flex justify-center w-[10rem] mb-2 pt-2 text-gray-600 text-xl border-t border-gray-600">
