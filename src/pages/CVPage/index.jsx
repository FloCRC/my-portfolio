...
export default function CVPage() {
    ...
    return (
        <>
            <div id="cv" className="flex h-screen min-h-[700px]">
                ...
                <div id="projectsMobile" className="hidden z-40 w-full min-h-[700px] py-6 ml-60 mr-10 pr-10 border-e border-grey flex-col justify-around lg:flex md:items-center md:border-e-0 md:mx-10 md:pr-0 md:py-10 md:my-12 sm:mx-5">
                    <a href="#home" className="flex flex-col w-full text-grey hover:opacity-70 hover:text-blueGrey">
                        ...
                        <h1 className="w-full pb-4 text-right font-semibold text-3xl font-['Outfit'] md:text-xl md:pb-0">Last Project</h1>
                    </a>
                    ...
                    <a href="#project1" className="flex flex-col w-full mt-3 text-grey hover:opacity-70 hover:text-blueGrey">
                        <p className="w-full text-right text-4xl md:text-2xl"><i className="fa-solid fa-angle-up"></i></p>
