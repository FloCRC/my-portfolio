...
export default function AllProjectsPage({ projects }) {
    ...
    return (
        <>
            <div id="projects" className="flex h-screen min-h-[700px]">
                ...
                <div id="projectsMobile" className="hidden z-40 items-center min-h-[700px] py-6 ml-60 mr-10 pr-10 border-e border-grey flex-col justify-around lg:flex md:border-e-0 md:mx-10 md:pr-0 md:py-10 md:my-12 sm:mx-5">
