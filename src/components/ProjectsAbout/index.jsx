export default function ProjectsAbout() {
    ...
    return (
        <>
            <a href="#home" className="flex flex-col w-full mb-12 text-gray-600 hover:text-blueGrey lg:hidden">
            ...
            <a href="#projects" className="flex flex-col w-full mb-12 text-gray-600 hover:text-blueGrey lg:hidden">
