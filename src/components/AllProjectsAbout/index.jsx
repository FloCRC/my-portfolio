    ...
    return (
        <>
            ...
            <div className="flex flex-col text-grey2">
                ...
                <p className="w-full pt-4 text-justify text-gray-600 font-['Playwrite_DE_Grund'] md:pt-2 sm:text-sm">My front-end projects are built using React and tailwindcss, while my back-end projects are built using PHP and MySQL.</p>
            </div>
            <a href="#project1" className="flex flex-col w-full mt-12 text-gray-600 text-grey hover:opacity-70 hover:text-blueGrey lg:hidden">
