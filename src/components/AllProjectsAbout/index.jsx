export default function AllProjectsAbout() {
    ...
    return (
        <>
            <a href="#home" className="flex flex-col w-full mb-12 text-grey hover:opacity-80 hover:text-red lg:hidden">
            ...
            <div className="flex flex-col">
                ...
                <p className="w-full pt-4 text-justify text-grey font-['Playwrite_DE_Grund'] md:pt-2 sm:text-sm">My front-end projects are built using React and tailwindcss, while my back-end projects are built using PHP and MySQL.</p>
            </div>
            <a href="#project1" className="flex flex-col w-full mt-12 text-grey hover:opacity-80 hover:text-red lg:hidden">
