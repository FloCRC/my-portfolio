    ...
    return (
        <>
            ...
            <div className="flex flex-col">
                ...
                <p className="w-full pt-4 text-justify text-grey font-['Playwrite_DE_Grund'] md:pt-2 sm:text-sm">My front-end projects are built using JavaScript, React and tailwindcss, while my back-end projects are built using PHP, Laravel and MySQL. I've created projects on my own, as well as projects in a team using Agile Methodologies. I've used Git for version control throughout these projects.</p>
            </div>
