    ...
    return (
        <>
            ...
            <div className="flex flex-col text-grey">
                ...
                <p className="w-full pt-4 text-justify font-['Playwrite_DE_Grund'] md:pt-2 sm:text-sm">My front-end projects are built using React and tailwindcss, while my back-end projects are built using PHP and MySQL.</p>
            </div>
